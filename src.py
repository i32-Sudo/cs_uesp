...
def skeleton_esp(viewMatrix, entity_class):
    ConnectedPoints = [
        '8|7|6|5|3', # Head->TopChest->MiddleChest->Lowe
        '7|38|64|39|62|50', # TopChest->LeftArm->Lefthnad
        '7|10|35|36|11|34|12|14', #TopChest->RightArm->Rig
    ...
    for x in ConnectedPoints:
        ...
        for i in range(len(expanded) - 1):  # Iterate up to len(expanded) - 1
            try:
                ...
                distance_threshold = 50  # Adjust the threshold value as needed
                distance = calculate_distance(bone1, bone2)
                    ...
                    try:
                        ...
                        if entity_addr:
                            ...
                            if not entity_class.bDormant and entity_class.health > 0:
                                ...
                                # Skeelton ESP #
                                skeleton_esp(viewMatrix, entity_class)
                                # Box ESP #
                                try:
